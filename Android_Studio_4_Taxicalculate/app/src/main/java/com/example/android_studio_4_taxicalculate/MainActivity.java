package com.example.android_studio_4_taxicalculate;
...
public class MainActivity extends AppCompatActivity {
    ...
    private View.OnClickListener the_texi = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            EditText findcount = (EditText)findViewById(R.id.edittext1);
            EditText findcount1 = (EditText)findViewById(R.id.edittext2);
            EditText findcount2 = (EditText)findViewById(R.id.edittext3);
            ...
            TextView cost = (TextView)findViewById(R.id.textview4);
            //里程低於250公尺時
            if (distance < 250){
                cost.setText("80 元");
            }//每250公尺時且費率加收5元
